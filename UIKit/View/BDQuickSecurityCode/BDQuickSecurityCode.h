//
//  BDQuickSecurityCode.h
//  BDQuickSecurityCode
//
//  Created by pcjbird on 2018/3/31.
//  Copyright © 2018年 Zero Status. All rights reserved.
//
//  框架名称:BDQuickSecurityCode
...
//! Project version number for BDQuickSecurityCode.
FOUNDATION_EXPORT double BDQuickSecurityCodeVersionNumber;

//! Project version string for BDQuickSecurityCode.
FOUNDATION_EXPORT const unsigned char BDQuickSecurityCodeVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <BDQuickSecurityCode/PublicHeader.h>

/**
 *@brief 输入完成回调Block
 */
typedef void(^BDQuickSecurityCodeBlock)(NSString *code);

/**
 *@brief A security/verify code input control. 一个安全码/验证码输入控件，支持4位或6位的安全码/验证码。
 */
@interface BDQuickSecurityCode : UIView
 ...
 *@brief 输入完成回调Block
 */
@property(nonatomic, copy) BDQuickSecurityCodeBlock complete;
