...
Pod::Spec.new do |s|
  ...
  s.public_header_files = "BDToolKit.h"
    ...
    s.subspec "BDWebJsonRequester" do |ss|
        ss.source_files  = "UIKit/View/BDWebJsonRequester/*.{h,m}"
        ss.public_header_files = "UIKit/View/BDWebJsonRequester/*.h"
    end
    ...
    s.subspec "BDVerifyCodeField" do |ss|
        ss.source_files  = "UIKit/View/BDVerifyCodeView/*.{h,m}"
        ss.public_header_files = "UIKit/View/BDVerifyCodeView/*.h"
    end
    
    s.subspec "BDVerifyCodeView" do |ss|
        ss.dependency 'BDToolKit/BDVerifyCodeField'
        ss.source_files  = "UIKit/View/BDVerifyCodeView/*.{h,m}"
        ss.public_header_files = "UIKit/View/BDVerifyCodeView/*.h"
    end
    ...
    s.subspec "UIScrollView+APParallaxHeader" do |ss|
        ss.source_files  = "UIKit/Catagory/UIScrollView+APParallaxHeader/*.{h,m}"
        ss.public_header_files = "UIKit/Catagory/UIScrollView+APParallaxHeader/*.h"
    end
