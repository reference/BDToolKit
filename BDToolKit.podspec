...
Pod::Spec.new do |s|
  ...
  s.name         = "BDToolKit"
  s.version      = "0.0.1"
  s.summary      = "A short description of BDToolKit."
  ...
  s.homepage     = "http://EXAMPLE/BDToolKit"
  ...
  s.author             = { "bandianhong" => "scottban@126.com" }
  ...
  s.source       = { :git => "http://EXAMPLE/BDToolKit.git", :tag => "#{s.version}" }
